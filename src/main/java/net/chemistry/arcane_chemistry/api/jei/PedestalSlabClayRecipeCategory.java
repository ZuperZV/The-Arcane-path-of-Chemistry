...
public class PedestalSlabClayRecipeCategory implements IRecipeCategory<PedestalSlabClayRecipe> {
    public final static ResourceLocation UID = ResourceLocation.fromNamespaceAndPath(Arcane_chemistry.MOD_ID, "pedestal_slab_clay");
    public static final RecipeType<PedestalSlabClayRecipe> RECIPE_TYPE = RecipeType.create(Arcane_chemistry.MOD_ID, "pedestal_slab_clay", PedestalSlabClayRecipe.class);
