...
public class PedestalSlabRecipeCategory implements IRecipeCategory<PedestalSlabRecipe> {
    public final static ResourceLocation UID = ResourceLocation.fromNamespaceAndPath(Arcane_chemistry.MOD_ID, "pedestal_slab");
    public static final RecipeType<PedestalSlabRecipe> RECIPE_TYPE = RecipeType.create(Arcane_chemistry.MOD_ID, "pedestal_slab", PedestalSlabRecipe.class);
    ...
    public Component getTitle() {
        return Component.literal("Aurora Pedestal");
    }
