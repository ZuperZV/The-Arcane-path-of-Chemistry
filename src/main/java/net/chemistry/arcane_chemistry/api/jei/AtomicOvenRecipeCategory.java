...
public class AtomicOvenRecipeCategory implements IRecipeCategory<AtomicOvenRecipe> {
    public final static ResourceLocation UID = ResourceLocation.fromNamespaceAndPath(Arcane_chemistry.MOD_ID, "atomic_oven");
    public static final RecipeType<AtomicOvenRecipe> RECIPE_TYPE = RecipeType.create(Arcane_chemistry.MOD_ID, "atomic_oven", AtomicOvenRecipe.class);
    ...
    public AtomicOvenRecipeCategory(IGuiHelper helper) {
        ...
        this.icon = helper.createDrawableIngredient(VanillaTypes.ITEM_STACK, new ItemStack(ModBlocks.ATOMIC_OVEN.get()));
    ...
    @Override
    public void draw(AtomicOvenRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics guiGraphics, double mouseX,
                     double mouseY) {
    ...
    @Override
    public void setRecipe(@NotNull IRecipeLayoutBuilder builder, AtomicOvenRecipe recipe, @NotNull IFocusGroup focuses) {
