...
public class CentrifugeRecipeCategory implements IRecipeCategory<CentrifugeRecipe> {
    public final static ResourceLocation UID = ResourceLocation.fromNamespaceAndPath(Arcane_chemistry.MOD_ID, "centrifuge");
    public static final RecipeType<CentrifugeRecipe> RECIPE_TYPE = RecipeType.create(Arcane_chemistry.MOD_ID, "centrifuge", CentrifugeRecipe.class);
    ...
    public Component getTitle() {
        return Component.translatable("block.arcane_chemistry.centrifuge");
    }
