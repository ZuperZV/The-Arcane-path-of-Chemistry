...
public class EmiPedestalSlabRecipe extends BasicEmiRecipe {
    ...
    public EmiPedestalSlabRecipe(PedestalSlabRecipe recipe) {
        super(ArcaneChemistryEmiPlugin.PEDESTAL_SLAB_CATEGORY, recipe.getId(), 100, 60);
