...
public class HardOvenMenu extends AbstractContainerMenu {
    private final BlockPos pos;
    private final HardOvenBlockEntity blockentity;
    public HardOvenMenu(int containerId, Player player, BlockPos pos) {
        super(ModMenuTypes.HARD_OVEN_MENU.get(), containerId);
        HardOvenBlockEntity HardOvenBlockEntity;
        this.pos = pos;

        if (player.level().getBlockEntity(pos) instanceof HardOvenBlockEntity blockentity) {
        ...
        this.blockentity = HardOvenBlockEntity;
    }

    @Override
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(blockentity.getLevel(), blockentity.getBlockPos()), player, ModBlocks.HARD_OVEN.get());
    }
