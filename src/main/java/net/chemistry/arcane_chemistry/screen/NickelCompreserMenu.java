...
public class NickelCompreserMenu extends AbstractContainerMenu {
    private final BlockPos pos;
    private final NickelCompreserBlockEntity blockentity;
    public NickelCompreserMenu(int containerId, Player player, BlockPos pos) {
        super(ModMenuTypes.NICKEL_COMPRESER_MENU.get(), containerId);
        NickelCompreserBlockEntity NickelCompreserBlockEntity;
        this.pos = pos;
        ...
        this.blockentity = NickelCompreserBlockEntity;
    }

    @Override
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(blockentity.getLevel(), blockentity.getBlockPos()), player, ModBlocks.NICKEL_COMPRESER.get());
    }
