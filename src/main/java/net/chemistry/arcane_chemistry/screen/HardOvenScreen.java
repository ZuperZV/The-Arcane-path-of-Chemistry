...
public class HardOvenScreen extends AbstractContainerScreen<HardOvenMenu> {
    private static final ResourceLocation TEXTURE =
            ResourceLocation.fromNamespaceAndPath(Arcane_chemistry.MOD_ID, "textures/gui/hard_oven_gui.png");

    public HardOvenScreen(HardOvenMenu container, Inventory inventory, Component title) {
