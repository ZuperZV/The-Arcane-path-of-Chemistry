package net.chemistry.arcane_chemistry.screen.renderer;
...
public class GasFluidTankRenderer {
    ...
    public GasFluidTankRenderer(long capacity, boolean showCapacity, int width, int height) {
        this(capacity, showCapacity ? TooltipMode.SHOW_AMOUNT_AND_CAPACITY : TooltipMode.SHOW_AMOUNT, width, height);
    }

    private GasFluidTankRenderer(long capacity, TooltipMode tooltipMode, int width, int height) {
