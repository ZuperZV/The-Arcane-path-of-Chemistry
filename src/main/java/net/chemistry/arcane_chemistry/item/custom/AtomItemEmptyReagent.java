...
public class AtomItemEmptyReagent extends Item {
    public final String elementName;
    private final int color;

    public AtomItemEmptyReagent(Properties properties, String elementName, int color) {
        super(properties);
    ...
    public InteractionResultHolder<ItemStack> use(Level p_40656_, Player p_40657_, InteractionHand p_40658_) {
        ...
        if (!list.isEmpty()) {
            ...
            return InteractionResultHolder.sidedSuccess(
                    this.turnBottleIntoItem(itemstack, p_40657_, new ItemStack(Items.DRAGON_BREATH)), p_40656_.isClientSide()
            );
        } else {
            ...
            if (blockhitresult.getType() == HitResult.Type.MISS) {
                ...
                if (blockhitresult.getType() == HitResult.Type.BLOCK) {
                    ...
                    if (p_40656_.getFluidState(blockpos).is(FluidTags.WATER)) {
                        ...
                        return InteractionResultHolder.sidedSuccess(
                                this.turnBottleIntoItem(itemstack, p_40657_, new ItemStack(ModItems.WATER_REAGENT.get())), p_40656_.isClientSide()
                        );
                    }
                }
