...
public class AtomItemReagent extends Item {
    ...
    public AtomItemReagent(Properties properties, String Skall, String elementName, int color, String Skallnumber,
                           ...
                           String Skallnumber8, int SkallnumberColor8 , int item_color) {
        super(properties);
